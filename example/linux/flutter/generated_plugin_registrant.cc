...
void fl_register_plugins(FlPluginRegistry* registry) {
  ...
  g_autoptr(FlPluginRegistrar) gameframework_unreal_registrar =
      fl_plugin_registry_get_registrar_for_plugin(registry, "UnrealEnginePlugin");
  unreal_engine_plugin_register_with_registrar(gameframework_unreal_registrar);
}
