...
public class UnityEngineController: GameEngineController {
    ...
    public override func unloadEngine() {
        DispatchQueue.main.async { [weak self] in
            ...
            // Unity on macOS doesn't support unloading without destroying
    ...
    private func loadUnityFramework() -> UnityFramework? {
        // On macOS, Unity framework is typically bundled in Frameworks directory
        let bundlePath = Bundle.main.bundlePath + "/Contents/Frameworks/UnityFramework.framework"
...
extension UnityFramework {
    func unloadApplication() {
        UnityFrameworkUnload(self.appController())
    }
