...
public class FlutterBridgeRegistry: NSObject {
    ...
    @objc public static var sharedController: NSObject? {
        ...
        set {
            ...
            if newValue != nil {
                NSLog("✅ FlutterBridgeRegistry: Controller registered")
            } else {
                NSLog("✅ FlutterBridgeRegistry: Controller unregistered")
            }
        }
    }
    ...
    @objc public static var sharedUnityFramework: NSObject? {
        ...
        set {
            ...
            if newValue != nil {
                NSLog("✅ FlutterBridgeRegistry: UnityFramework registered")
            } else {
                NSLog("✅ FlutterBridgeRegistry: UnityFramework unregistered")
            }
        }
    }
